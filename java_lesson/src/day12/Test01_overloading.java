...
/*
	...
	==> 원칙적으로 같은 클래스 내에서는 함수의 이름은 모두 달라야 한다.
		...
		단, 다음 조건은 무조건 충족해줘야 한다.
		
			조건 ]
				1. 함수의 이름이 같아야한다.
				2. 매개변수리스트의 형태가 달라야 한다.
					==> 매개변수의 갯수, 순서, 형태 중 적어도 한개는 달라야 한다.
				3. 반환값과는 전혀 상관없다.
	...
	==> 상속관계에 있는 하위 클래스에서 
		...
		참고 ]
			접근지정자 : 클래스, 함수, 변수를 사용할 수 있는 권한을 지정하는 것.
				...
				public		: 모든 곳에서...
				protected	: 같은 패키지 내거나 상속받은 클래스 내에서는 사용가능
				생략		: 같은 패키지내 그리고 같은 클래스에서 사용 가능
				private		: 같은 클래스내에서 만
				
			***
			클래스의 접근지정자는 public 과 생략만 사용가능하다.
 ...
 */
	public Test01_overloading() {
		...
		System.out.println("Test01_Sub1.getNum() : " + t1.getNum());
...
// Test01_Sub2를 Test01_Sub을 상속받아서 만들고

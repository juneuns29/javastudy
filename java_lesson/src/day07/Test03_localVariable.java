...
/*
	지역변수(Local Varible)
	==> 변수중 생성된 지역에서만 사용할 수 있는 변수
	
		함수 내에서 생성된 변수는 Stack에 만들어진다.
	...
	**
	이때 안쪽에 있는 반복문은 감싸고 있는 반복문 반복진행하면
	...
	flag 기법
		==>	우리가 프로그램을 실행하다 보면
			...
			예 ]
				...
				이때  for 반복문이 모두 제대로 실행되어서 종료 되었는지
				아니면 중간에 특정조건을 만나서 종료되었는지를 알아내는 방법

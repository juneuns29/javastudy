...
//		jisoo.name = "지수";
		...
		/*
		// 제니의 이름, 나이 출력
		System.out.println("제이 이름 : " + jennie.name + 
									", 나이 : " + jennie.age);
		System.out.println("지수 이름 : " + jisoo.name + 
									", 나이 : " + jisoo.age);
		*/
		System.out.println("제이 이름 : " + jennie.getName() + 
				", 나이 : " + jennie.getAge());
		System.out.println("지수 이름 : " + jisoo.getName() + 
				", 나이 : " + jisoo.getAge());
		
		BlackPink lisa = new BlackPink("리사", 30, "010-2424-2424", 'O');
		System.out.println("리사 이름 : " + lisa.getName() + 
							", 나이 : " + lisa.getAge() + 
							", 전화번호 : " + lisa.getTel() + 
							", 혈액형 : " + lisa.getbType()
				);

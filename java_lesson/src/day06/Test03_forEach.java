...
//			주의 ]
		...
		*/
		...
		for(String[] memb : blackPink) {
			...
			/*
				참고 ]
					...
					Arrays.toString(blackPink[3]) ==> "[지수, 29, 010-3939-3939, 여자, A형]"
			 */
		}
		...
		for(String memb[] : blackPink) { // 멤버꺼내고
			// 각 멤버의 정보 꺼내고
		...
		System.out.println("*** for 명령으로 거내기 ***");
		for(int i = 0 ; i < blackPink.length ; i++ ) {
			// 먼저 멤버꺼내고
			// 4명의 데이터를 모아놓은 배열이므로 blackPink의 길이는 4

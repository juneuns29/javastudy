...
/*
	랜덤하게 숫자 두개를 발생시켜서
	두수의 계산결과를 반환해주는 프로그램을 작성하세요.
	처리는 함수를 제작해서 처리하는 것으로 하세요.
	
	해결방법 ]
		1. 랜덤하게 정수 두 개를 발생시키는 기능
		
		2. 발생된 두수와 연산기호를 입력해주면 그 결과를 반환해주는 기능
...
//		System.out.println("연산기호 : " + giho);
		...
		// 결과 출력
		System.out.printf("랜덤하게 발생된 두수 [ %2d ]와 [ %2d ]의 [ %c ]연산은 %5.2f입니다.", 
		...
		// 결과출력
		System.out.printf("입력받은 두 정수 [ %2d ] 와 [ %2d ] 의 [ %c ] 연산은 [ %5.2f ] 입니다.", 
																		no1, no2, buho, result1);

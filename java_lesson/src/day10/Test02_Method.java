...
/*
	두 정수를 입력받아서 더한 값을 반환해주는 함수 sum 을 제작해서
	랜덤하게 두수를 입력해서 더한 결과를 출력하세요.
 */
public class Test02_Method {
	int hap;
	
/*
	함수를 제작하는 위치는 클래스블럭 아래에서만 만들 수 있다.
	
	참고 ]
		함수를 만드는 이유
		: 프로그램을 만들다보면 여러행의 코드가 반복적으로 사용되어야 될 때가 생긴다.
			반복되는 이 코드들을 하나로 묶어서 실행할 수 있다면 편리해질 것이다.
			이것이 함수다.
 */
	// 여기서 함수를 만들어도 되고
...
//		System.out.println("A.CODE1 : "  + A.CODE1);
		...
		System.out.println(t1.sum(10, 20, 100));
